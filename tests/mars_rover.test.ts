...
describe("Mars Rover", () => {
  ...
  describe("moves forward", () => {
    it("can move forward facing east", () => {
      const rover = new MarsRover([0, 0], "e", [50, 50]);
      rover.move("f");
    ...
    it("can move forward facing west", () => {
      const rover = new MarsRover([1, 0], "w", [50, 50]);
      rover.move("f");
      expect(rover.getLocation()).toEqual([0, 0]);
    });
    it("can move forward facing north", () => {
      const rover = new MarsRover([0, 1], "n", [50, 50]);
      rover.move("f");
      expect(rover.getLocation()).toEqual([0, 0]);
    });
    it("can move forward facing south", () => {
  ...
  describe("it wraps from one end of the grid to another", () => {
    ...
    it("will continue form last index if y index exceeds grid during movement forward facing north", () => {
      const rover = new MarsRover([0, 0], "n", [10, 10]);
      rover.move("f");
      expect(rover.getLocation()).toEqual([0, 10]);
    });
    it("will continue form last index if y index exceeds grid during movement backward facing south", () => {
      const rover = new MarsRover([0, 0], "s", [10, 10]);
      rover.move("b");
      expect(rover.getLocation()).toEqual([0, 10]);
    });
  });
